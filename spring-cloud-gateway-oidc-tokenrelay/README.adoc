...
==== Configuration
In terms of configuration we again have to separate concerns.
...
While this post outlines the basics for a functioning gateway, further work might be needed in terms of session duration, persistence and token refresh flows.
