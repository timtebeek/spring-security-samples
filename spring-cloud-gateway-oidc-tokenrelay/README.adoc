...
The Flights service swaps out the `JwtDecoder` bean for a mock, https://docs.spring.io/spring-security/site/docs/5.2.x/reference/htmlsingle/#testing-bearer-authentication[as indicated in the documentation].
...
Which style fits your service best depends on how thorough and which aspects of JWT handling you want to test specifically.
