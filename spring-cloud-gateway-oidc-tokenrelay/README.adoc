...
==== Testing
The Hotels and Flights service both https://docs.spring.io/spring-security/site/docs/5.2.x/reference/htmlsingle/#testing-bearer-authentication[swap out the `JwtDecoder` bean for a mock].
