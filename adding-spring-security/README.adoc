...
https://docs.spring.io/spring-security/reference/5.7.1/servlet/test/mockmvc/oauth2.html#testing-jwt[`spring-security-test`] library to our test class path.
...
https://docs.spring.io/spring-security/reference/5.7.1/servlet/test/mockmvc/oauth2.html#testing-jwt[as alluded to in the documentation].
...
https://docs.spring.io/spring-security/reference/5.7.1/servlet/authorization/index.html[the Authorization chapter of Spring Security].
