...
Simple enough! For a version of our application without any security in place have a look at https://github.com/timtebeek/spring-security-workshop/tree/master/adding-spring-security/leaveapp-initial[leaveapp-initial].
...
https://github.com/spring-projects/spring-boot/blob/2.6.x/spring-boot-project/spring-boot-autoconfigure/src/main/java/org/springframework/boot/autoconfigure/security/servlet/UserDetailsServiceAutoConfiguration.java[`UserDetailsServiceAutoConfiguration`]:
[source,text]
----
...
https://docs.spring.io/spring-security/reference/5.6.3/servlet/oauth2/resource-server/jwt.html[As indicated in the documentation], configuration takes the form of:
...
During development we will either link:keycloak/README.adoc[use Keycloak] or link:wiremock/README.adoc[WireMock] to serve the configured `issuer-uri` endpoint.
...
https://github.com/spring-projects/spring-boot/blob/2.6.x/spring-boot-project/spring-boot-autoconfigure/src/main/java/org/springframework/boot/autoconfigure/security/oauth2/resource/servlet/OAuth2ResourceServerJwtConfiguration.java[`OAuth2ResourceServerJwtConfiguration`], which has provided us with a `JwtDecoder` to handle incoming tokens.
...
----
By default Spring Security adds https://docs.spring.io/spring-security/reference/5.6.3/servlet/exploits/csrf.html[Cross Site Request Forgery] protection for `POST` requests.
...
https://docs.spring.io/spring-security/reference/5.6.3/servlet/test/mockmvc/oauth2.html#testing-jwt[`spring-security-test`] library to our test class path.
...
https://docs.spring.io/spring-security/reference/5.6.3/servlet/test/mockmvc/oauth2.html#testing-jwt[as alluded to in the documentation].
...
https://docs.spring.io/spring-security/reference/5.6.3/servlet/authorization/index.html[the Authorization chapter of Spring Security].
