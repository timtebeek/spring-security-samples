...
https://docs.spring.io/spring-security/reference/5.6.4/servlet/oauth2/resource-server/jwt.html[As indicated in the documentation], configuration takes the form of:
...
----
By default Spring Security adds https://docs.spring.io/spring-security/reference/5.6.4/servlet/exploits/csrf.html[Cross Site Request Forgery] protection for `POST` requests.
...
https://docs.spring.io/spring-security/reference/5.6.4/servlet/test/mockmvc/oauth2.html#testing-jwt[`spring-security-test`] library to our test class path.
...
https://docs.spring.io/spring-security/reference/5.6.4/servlet/test/mockmvc/oauth2.html#testing-jwt[as alluded to in the documentation].
...
https://docs.spring.io/spring-security/reference/5.6.4/servlet/authorization/index.html[the Authorization chapter of Spring Security].
